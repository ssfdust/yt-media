...
class TestGeneralAccess(FixturesInjectBase):
    ...
    @pytest.mark.parametrize(
        "http_method, view, kw",
        (
            ("GET", "Group.GroupListView", {}),
            ("GET", "Group.GroupView", {}),
            ("POST", "Group.GroupView", {}),
            ("DELETE", "Group.GroupView", {}),
            ("GET", "Group.GroupItemView", {"group_id": 1}),
            ("PUT", "Group.GroupItemView", {"group_id": 1}),
            ("DELETE", "Group.GroupItemView", {"group_id": 1}),
        ),
    )
