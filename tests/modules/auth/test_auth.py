...
class TestAuthModule:
    ...
    def test_user_login_captcha(self, flask_app_client, captcha, code, token):
        flask_app_client.get("/api/v1/auth/captcha?token=1212")
        login_data = {
    ...
    #      self, flask_app_client, username, inactive_user, password, active, code
    #  ):
