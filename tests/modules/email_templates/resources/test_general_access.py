...
class TestGeneralAccess(FixturesInjectBase):
    ...
    @pytest.mark.parametrize(
        "http_method, view, kw",
        (
            ("GET", "EmailTemplate.EmailTemplateListView", {}),
            ("GET", "EmailTemplate.EmailTemplateView", {}),
            ("POST", "EmailTemplate.EmailTemplateView", {}),
            ("DELETE", "EmailTemplate.EmailTemplateView", {}),
            ("GET", "EmailTemplate.EmailTemplateItemView", {"email_template_id": 1}),
            ("PUT", "EmailTemplate.EmailTemplateItemView", {"email_template_id": 1}),
            ("DELETE", "EmailTemplate.EmailTemplateItemView", {"email_template_id": 1}),
        ),
    )
