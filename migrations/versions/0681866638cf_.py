...
def upgrade():
    ...
    sa.Column('modified', sa.DateTime(timezone=True), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"), nullable=False),
    ...
    op.create_table('groups_relation',
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('garbage_storages',
    ...
    op.create_table('menus_relation',
    ...
    sa.Column('created', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=False),
    sa.Column('name', sa.VARCHAR(length=128), autoincrement=False, nullable=False),
    sa.Column('user_name', sa.VARCHAR(length=128), autoincrement=False, nullable=False),
    ...
    sa.Column('filetype', sa.VARCHAR(length=256), autoincrement=False, nullable=True),
    sa.Column('storetype', sa.VARCHAR(length=256), autoincrement=False, nullable=True),
    ...
    sa.Column('name', sa.VARCHAR(length=128), autoincrement=False, nullable=False),
    sa.Column('collected_amount', sa.NUMERIC(precision=20, scale=2), autoincrement=False, nullable=False),
    sa.Column('amount', sa.NUMERIC(precision=20, scale=2), autoincrement=False, nullable=False),
